...
class M_pertanyaan_GPMP extends CI_Model {
	...
	{
		$this->db->select("*");
		$this->db->from("pertanyaan_gpmp");
		$this->db->join("subkategori_gpmp", "pertanyaan_gpmp.id_subktg_gpmp = subkategori_gpmp.id_subktg_gpmp");				
