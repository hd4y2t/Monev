<div class="content mt-3">
	<div class="card">
	<?php if(isset($_GET["p"])){
		include "v_input_pertanyaan_gpmf.php";
	}else{
	?>
    ...
    <div class="card-body card-block">
		...
		<?php
			include "koneksi.php";
			$sql=mysqli_query($k,"select * from kategori_gpmf");
			$id=1;
			while($data=mysqli_fetch_array($sql)){
				?>
				<div class="panel-heading">
					<h4 class="panel-title">
					<a data-toggle="collapse" href="#collapse<?php echo $id ?>"><?php echo $data["nama_kategori_gpmf"] ?></a>
					</h4>
				</div>				
				<div id="collapse<?php echo $id ?>" class="panel-collapse collapse">
				<ul class="list-group">
				<?php
				$sql2=mysqli_query($k, "select * from subkategori_gpmf where id_ktg_gpmf='$data[id_ktg_gpmf]'");
				while($data2=mysqli_fetch_array($sql2)){
					?>
					<li class="list-group-item"><a href="?p=<?php echo $data2["id_subktg_gpmf"] ?>"><?php echo $data2["nama_sub_ktg"] ?></a></li>
