<div class="content mt-3">
	...
	<?php foreach($data_pertanyaan as $data){ ?>
		<form action="<?php echo base_url() ?>pertanyaan_gpmf/input_data_detail" method="post" class="form-horizontal">
		<div class="row form-group" style="display:none">
            <div class="col col-md-2">
				<label class="form-control-label">Id</label>
			</div>
            <div class="col-12 col-md-10">
				<textarea name="id" class="form-control" required autocomplete="off" rows="4" readonly><?php echo $data->id_pertanyaan_gpmf ?></textarea>				
			</div>
		</div>
