<div class="content mt-3">
    ...
    <div class="card-header">
        <strong>Input Temuan GPMP</strong>		
    </div>
    <div class="card-body card-block">
        ...
        <a class="btn btn-success btn-sm" href="<?php echo base_url() ?>hasiltemuanGPMP">Refresh</a>
        </form>
...
<?php
	if(isset($_POST["simpan"])){
		include 'koneksi.php';
		$sql=mysqli_query($k,"insert into hasil_temuan_GPMP values ('','$_SESSION[tahun]','$_POST[nama_lembaga]','$_POST[nama_fakultas]','$_POST[nama_prodi]','$_POST[hari]','$_POST[tanggal]','$_POST[catatan_temuan]','$_POST[saran_perbaikan]','$_SESSION[id]')");
		if($sql){
